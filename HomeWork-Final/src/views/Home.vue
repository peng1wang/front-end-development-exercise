	...
	data() {
		return {
			...
			types: [
				...
				{ text: '电影/演出', id: '2', img: '02.png' },
				{ text: '酒店', id: '3', img: '03.png' },
				{ text: '休闲', id: '4', img: '04.png' },
				{ text: '外卖', id: '5', img: '05.png' },
				{ text: '打车', id: '6', img: '06.png' },
				{ text: '周边游/旅游', id: '7', img: '07.png' },
				{ text: '医疗/牙科', id: '8', img: '08.png' },
				{ text: '美团优选', id: '9', img: '09.png' },
				{ text: '火车票/机票', id: '10', img: '10.png' },
			],
			// 预定义出来
			ad: [],
			list: []
